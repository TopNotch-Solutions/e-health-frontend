...
const DOCTOR_DEPT = 'master_doctor';

export function useClinicDoctorQueue({ onQueueSynced } = {}) {
  ...
  useEffect(() => {
    ...
    const handleLiveEvent = () => requestDepartmentQueueRefresh(DOCTOR_DEPT);
...
export function useClinicDoctorSession() {
