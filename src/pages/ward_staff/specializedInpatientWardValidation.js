...
export function validateSpecializedInpatientDailyRecord(vitals = {}) {
  const errors = {};
...
/** @returns {Record<string, string>} */
export function validateSpecializedInpatientPorterTransport({
  equipmentRequired,
  equipmentNotes,
  criticalNotes,
  checklist,
...
/** @returns {Record<string, string>} */
export function validateSpecializedInpatientMortuaryTransfer({
  causeOfDeath,
  equipmentRequired,
  equipmentNotes,
  criticalNotes,
  ...
  const errors = validateSpecializedInpatientPorterTransport({
    equipmentRequired,
    equipmentNotes,
    criticalNotes,
    checklist,
...
/** @returns {Record<string, string>} */
export function validateSpecializedInpatientDischarge({ dischargeNotes }) {
  const errors = {};
