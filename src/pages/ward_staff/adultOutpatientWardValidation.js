...
export const TRANSFER_WARD_OPTIONS = [
  ...
  { value: 'icu', label: 'ICU' },
  { value: 'specialized_inpatient', label: 'Inpatient' },
];
...
export function validateAdultOutpatientDailyRecord(vitals = {}) {
  const errors = {};
...
/** @returns {Record<string, string>} */
export function validateAdultOutpatientPorterTransport({
  equipmentRequired,
  equipmentNotes,
  criticalNotes,
  checklist,
...
/** @returns {Record<string, string>} */
export function validateAdultOutpatientMortuaryTransfer({
  causeOfDeath,
  equipmentRequired,
  equipmentNotes,
  criticalNotes,
  ...
  const errors = validateAdultOutpatientPorterTransport({
    equipmentRequired,
    equipmentNotes,
    criticalNotes,
    checklist,
...
/** @returns {Record<string, string>} */
export function validateAdultOutpatientDischarge({ dischargeNotes }) {
  const errors = {};
  if (!String(dischargeNotes ?? '').trim()) {
    errors.discharge_notes = 'Discharge notes are required';
  }
  return errors;
}
