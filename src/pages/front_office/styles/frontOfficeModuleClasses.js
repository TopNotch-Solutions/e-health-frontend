...
import { greenCard, greenCardLg, greenOn, greenTable } from '../../styles/cardSurfaces';
...
export const fo = {
  ...
  form: 'space-y-4',
  sectionPanel: `${greenCardLg} p-5 sm:p-6`,
  sectionTitle: `${greenOn.title} mb-4`,
  ...
  actionCardEmergency:
    'group w-full rounded-lg border border-rose-200 bg-rose-50/90 p-5 text-left shadow-sm transition hover:border-rose-300 hover:bg-rose-50 focus:outline-none focus:ring-2 focus:ring-rose-500/40 disabled:cursor-not-allowed disabled:opacity-60',
  actionIcon:
